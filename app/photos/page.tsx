...
export const metadata: Metadata = {
  title: "Photos | Prasidh P Shetty",
  metadataBase: new URL("https://prasidhpshetty.com/photos"),
  description: "Explore photos taken by Prasidh P Shetty",
  openGraph: {
    title: "Photos | Prasidh P Shetty",
    url: "https://prasidhpshetty.com/photos",
    description: "Explore photos taken by Prasidh P Shetty",
    images:
      "https://prasidhpshetty.com/photos.png",
  },
};
