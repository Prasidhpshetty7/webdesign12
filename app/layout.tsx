...
const options = {
  ...
  description:
    "Prasidh P Shetty is a Web Designer and Full-Stack Developer passionate about building modern, visually engaging, and user-focused digital experiences",
  url: "https://prasidhpshetty.com",
  ogImage:
